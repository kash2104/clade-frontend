...
const Company = () => {
  return (
    <>
      <div className="left-[100px] ml-[100px] mt-10 mb-5 w-[736px] h-[271px] gap-4 flex flex-col">
        <div className="w-[148px] h-[60px] pt-[10px] pr-[10px] pb-[10px] pl-0 gap-[10px] flex">
          <div className="w-[138px] h-[40px] gap-3 flex items-center justify-center">
            ...
            <div className="w-[86px] h-[27px] font-500 text-[20px] leading-[27px] text-[rgba(79,79,79,1)]">
              Atlassian
            </div>
          </div>
        </div>

        <div className="w-[736px] h-[195px] gap-16 flex">
          <div className="gap-7 flex flex-col h-max">
            <div className="w-[344px] h-[49px] flex flex-col gap-2">
            ...
            <div className="w-[344px] h-[49px] gap-2 flex flex-col">
