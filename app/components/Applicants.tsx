  ...
  return (
    <>
      <div className="w-[336px] h-[42px] flex items-center justify-between">
        <div className="w-[135px] h-[42px] p-[10px] gap-[10px] flex items-center justify-center">
        ...
        <div className="w-[57px] h-[39px] pt-[6px] pb-[6px] pl-[10px] pr-[10px] gap-[10px] flex">
          <div className="w-[37px] h-[27px] font-600 text-[20px] leading-[27px] text-[rgba(61,61,61,1)]">
            {number}
          </div>
        </div>
      </div>
